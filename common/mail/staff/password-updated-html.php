...
?>
    ...
    <head>
        <title>
            Your Plugn CRM password has been changed
        </title>
        <!--[if !mso]><!-- -->
                                                ...
                                                <tr>
                                                    ...
                                                    >
                                                        ...
                                                        <div
                                                            style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;text-align:left;color:#000000;"
                                                        >
                                                            Of course, if you did not request this reset, then that's a problem we need to know about. Write to us immediately <a href='mailto:contact@plugn.io'>here</a> and we'll get it sorted out.
                                                        </div>
